...
export default function HomeScreen() {
  createImages = () => {
    ...
    for (let i = 0; i < 10; i++) {
      myimage.push(
        <TouchableHighlight
          onPress={() => alert('select your donation type')}
          underlayColor="white">
          <Image
            style={styles.logo}
            source={{
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView nativeID="OverAllVerticalScroll">
        ...
        <View
          nativeID="nonProfitOgranizationContainer"
        ...
        <View
          nativeID="recentWorldNewsContainer"
          style={styles.recentWorldNewsContainer}>
          <Text>Weather-Related Disaster Areas In Need</Text>
